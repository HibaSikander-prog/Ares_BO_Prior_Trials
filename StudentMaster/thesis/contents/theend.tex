...
\textbf{Optimizer} & Median & Mean & Median & Mean & Median & Mean \\
\midrule
...
% Part (b): Improvement and efficiency metrics
...
\toprule
 ...
 & \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
\textbf{Optimizer} & Median & Mean & Median & Mean & Median & Mean & \textbf{Success rate} \\
\midrule
...
across every metric, not just in how good the final solution is, but also in how quickly and reliably the optimizer gets there. 
