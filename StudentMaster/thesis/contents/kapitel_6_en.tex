...
Some other research direction that could push this project work further for future work could be 
tuneable parameters increments. The ARES problem only has 5 tuneable parameters that were the 5 magnets, 
but a real beamline can have dozens of them At such scale the GP gets expensive and it gets 
harder for acquisition function to search, so combining the cheetah prior with dimensionality 
...
(centering the beam and focusing the beam) and use mutli-objective BO instead of combining everything to a single MAE,
...
complex objectives like the ones used in European XFEL and PETRA III. 
