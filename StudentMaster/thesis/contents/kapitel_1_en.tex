...
\label{b:picturesubsection}

\cref{f:picfirstfigure} shows a block diagram.
...
You can include figures by using the command \verb'\afig{scale}{path/to/figure.ext}'. This works for extensions like \texttt{pdf}, \texttt{png}, \texttt{jpg}. To include tikz figures, use the command \verb'\tikzfig{scale}{path/to/figure}'.
