...
Particle accelerators are among the most advanced scientific apparatus ever developed 
to perform ground breaking scientific experiments. The Deutsches Elektronen-Synchrotron 
(DESY) \cite{DESYwebsite} located in Hamburg hosts multiple top notch accelerator facilities such as 
European X-Ray Free Electron Laser (European XFEL) and the PETRA III synchrotron radiation 
source. These facilities accelerate electrons to almost the speed of light, producing intense 
...
systems. Therefore automated optimization methods are crucial for effective accelerator performance. \

Several optimization algorithms have been applied to particle accelerator tuning problems with their own unique 
advances and disadvantages. Nelder-Mead Simplex is gradient free optimization techniques and is one of the approaches 
that is widely used because of its simplicity and robustness. However they do not create models that generalize across many 
optimization runs and usually need many function evaluations to converge \cite{nelder1965simplex}. Another approach is the Reinforcement Learning (RL) 
...
as well as predictions. This makes it possible for assessment points wisely balancing between both exploration and exploitation. BO is 
...
We can map the passage of charged particles via magnets using a reliable model and they travel through magnetic fields according to 
well established physics knowledge and thus, all thanks to modern simulation library like Cheetah \cite{kaiser2024bridging} that we can now predict beam 
...
from simulations and the models produced may not generalize well to new conditions. 




\subsection{Cheetah as Physics Informed Prior}
