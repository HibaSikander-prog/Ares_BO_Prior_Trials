...
print("Tracking method for each quadrupole:")
print(f"AREAMQZM1.tracking_method: {ares_ea.AREAMQZM1.tracking_method}")
print(f"AREAMQZM2.tracking_method: {ares_ea.AREAMQZM2.tracking_method}")
print(f"AREAMQZM3.tracking_method: {ares_ea.AREAMQZM3.tracking_method}")

# Check what tracking methods are available
print("\nChecking if we can change tracking method...")
print(f"Available methods: Look at Cheetah docs or try: 'bmadx' or other options")

# Try with bmadx tracking (which might support misalignments)
print("\n--- Testing with different tracking method ---")
