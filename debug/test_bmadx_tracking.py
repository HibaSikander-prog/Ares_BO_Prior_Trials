...
print("Testing with bmadx tracking (requires ParticleBeam)...")
...
# MUST use ParticleBeam for bmadx
incoming_beam = cheetah.ParticleBeam.from_parameters(
    num_particles=10000,  # Use fewer particles for speed
...
if abs(mae_yes.item() - mae_no.item()) > 1e-6:
    print("\n✓✓✓ SUCCESS!  Misalignments work with 'bmadx' tracking!  ✓✓✓")
else:
    print("\n✗ Still doesn't work")